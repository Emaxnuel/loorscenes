...
AFRAME.registerComponent('eventos', {
  ...
  init: function () {
    ...
    document.querySelector('a-scene').addEventListener('loaded', function () {
     ...
     // setTimeout(function(){ rigCamera.setAttribute('animation', "property: position; from: 0 0 0; to: 0 0 -100; dur: 2000; easing: linear; loop: true"); }, 5000);

     // setTimeout(function(){ rigCamera.removeAttribute('animation'); }, 25000);
...
setTimeout(function(){ sceneBackground.setAttribute('fog', "far: 200");
      ...
      ps1.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      ps2.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      ps3.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      ps4.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      ps5.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");

      manoModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      columnaModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      puntaModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      monolitoModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      neandertalModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #collisionA");
      ...
      collisionScene.onended = function() {
        ...
        camera.setAttribute('position', '-2 0 -4');
        ...
        */
        ...
        skyConstellation.parentNode.removeChild(skyConstellation);
            ...
            ps1.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            ps2.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            ps3.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            ps4.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            ps5.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");

            manoModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            columnaModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            puntaModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            monolitoModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
            neandertalModel.setAttribute('audioreactive-on-beat-int', "analyserEl: #atomA");
